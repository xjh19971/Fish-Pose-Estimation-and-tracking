...
def stage1_block(x, num_p, branch, weight_decay):
    ...
    x = identity_block(x, 3, [64, 64, 256], stage=1, block=str(branch)+'_a',weight_decay=(weight_decay,0))
    x = identity_block(x, 3, [64, 64, 256], stage=1, block=str(branch)+'_a',weight_decay=(weight_decay,0))
...
def stageT_block(x, num_p, stage, branch, weight_decay):
    ...
    x = identity_block(x, 3, [64, 64, 256], stage=stage, block=str(branch)+'_a',weight_decay=(weight_decay,0))
    x = identity_block(x, 3, [64, 64, 256], stage=stage, block=str(branch)+'_a',weight_decay=(weight_decay,0))
